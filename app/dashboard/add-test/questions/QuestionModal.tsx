...
const QuestionModal: React.FC<QuestionModalProps> = ({
  ...
  const handleAddOption = () => {
    ...
    setOptions([
      ...options,
      { id: Date.now(), label: nextLabel, text: "", isCorrect: false },
    ]);
  };
    ...
    const formattedQuestion = {
      ...
      options:
        type !== "Text"
          ...
          : null,
      description:
        type === "Text" ? "Sample description for text question..." : null,
    };
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl min-h-[80vh] flex flex-col my-8 animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between px-8 py-6 border-b border-gray-50">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full border border-gray-100 flex items-center justify-center text-gray-400 text-sm font-medium">
              1
            </div>
                ...
                <div key={opt.id} className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4 text-sm">
                      <div className="w-7 h-7 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 text-xs font-bold">
                        {opt.label}
                      </div>
